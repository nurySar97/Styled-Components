...
const PlaystarzButton = props => {
    ...
    const BUTTON_NODE = useRef('');
    const childType = props.children.constructor.name;
    ...
    const onMouseDown = event => {
        ...
        const uniqueId = v4();
        const ObjectWave = { Component: <Wave key={uniqueId} uniqueId={uniqueId} setRipples={setRipples} styles={{ size, topY, leftX }} />, uniqueId };
        setRipples(prev => ([...prev, ObjectWave]));
    }
